...
<body>
    ...
    <div id="position">
        <div class="container">
            <ul>
                ...
                <li>Regjistro Restaurantin</li>
            </ul>
            <a href="#0" class="search-overlay-menu-btn"><i class="icon-search-6"></i> Kërko</a>
        </div>
    </div><!-- Position -->
    ...
    <div class="white_bg">
        ...
        <div class="container margin_60">
            <div class="main_title margin_mobile">
                <h2 class="nomargin_top">Ju lutem plotësoni formulën</h2>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <form action="/register/restaurant" method="POST">
                            ...
                            <div class="text-center"><button class="btn_full_outline">Dërgo</button></div>
                        </form>
                    </div><!-- End col  -->
                </div><!-- End row  -->
            </div><!-- End container  -->
