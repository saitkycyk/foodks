...
<div class="container margin_60">
	<div id="tabs" class="tabs">
		<nav>
			<ul>
				<li><a href="#section-1" class="icon-profile"><span>Porositë aktive</span></a>
				</li>
				<li><a href="#section-2" class="icon-profile"><span>Porositë e vjetra</span></a>
				</li>
			</ul>
		</nav>
		<div class="content">
					...
					<table class="table table-bordered" style="border:2px solid #c5c5c5;">
						...
						<tbody>
							<tr>
								...
								<td>{{ucfirst($oldOrderGroup->status)}}</td>
